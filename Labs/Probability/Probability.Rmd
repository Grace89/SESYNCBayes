...
12. Existing literature shows that the proportion of habitat patches containing at least one rare plant individual is $\mu = 0.04$ with a standard deviation $\big(\sigma\big)$ of 0.01. Write out a model for the distribution of $\phi$, conditional on $\mu$ and $\sigma$.  
